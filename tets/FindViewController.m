...
@interface FindViewController ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,WMPlayerDelegate>{
...
//    UIImageView *imgview=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 100, 25)];
    UILabel *titlelabel=[[UILabel alloc]initWithFrame:CGRectMake(0, 10, kScreenWidth, 64)];
...
-(void)settab{
    ...
    self.table.backgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"defualt"]];
    ...
    //
    self.table.backgroundColor=[UIColor colorWithRed:244/255.0 green:244/255.0 blue:244/255.0 alpha:1];
    [_table registerClass:[VideoCell class] forCellReuseIdentifier:@"cell"];
...
-(void)loadData{
   // NSString *urlstr=[NSString stringWithFormat:@"http://c.m.163.com/nc/video/home/%ld-10.html",_count];
     NSString *urlstr=[NSString stringWithFormat:@"http://c.3g.163.com/nc/video/list/%@/y/%ld-10.html",self.videoType,_count];
    ...
    [BANetManager ba_requestWithType:BAHttpRequestTypeGet
                        ...
                        successBlock:^(id response) {
                            ...
                            NSArray *array=[response objectForKey:self.videoType];
                            NSLog(@"视频:%@",array);
...
//    wmPlayer.bottomView.alpha = 1.0;
//    wmPlayer.topView.alpha = 1.0;
